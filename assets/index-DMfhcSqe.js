...
`,E=new Set;function J(){const t="shared-unified-styles";if(!document.getElementById(t)){const i=document.createElement("style");i.id=t,i.textContent=X,document.head.appendChild(i)}}function Z(){E.forEach(t=>{const i=document.getElementById(t);i&&i.remove()}),E.clear()}J();function z(t,i=!1){const o=Math.round(f/D*100);return`
...
`;document.head.appendChild($);function q(t=!0){const i=document.getElementById("app");switch(document.getElementById("meshGradientBg"),Z(),i.innerHTML="",c){case 0:ie();break;case 1:se();break;case 2:oe();break;case 3:ne();break;case 4:ae();break;case 5:re();break;case 6:le();break;case 7:pe();break;case 8:ce();break;case 9:ue();break}t&&(c===0||c===1||c===2||c===8)&&ee(),I()}function ee(){const i=document.getElementById("app").firstElementChild;i&&i.classList.add("page-transition-enter")}let b=[];function te(){b.forEach(t=>clearTimeout(t)),b=[]}function ie(){te();const t=document.getElementById("app"),i=M(e("onboarding.page1.totalDownloads")),o=M(e("onboarding.page1.happyArtists")),a=(s,n)=>`
    <div style="display: flex; align-items: center; justify-content: center; gap: 16px; margin: 0 auto;">
      ...
      <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
        ...
        <p class="subtitle" style="margin: 0;">${n}</p>
      </div>
  ...
  `;t.innerHTML=`
    <div class="container" style="position: relative; display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100vh; height: 100dvh;">
      ...
      >
        <h1 style="font-size: 32px; white-space: normal; margin-bottom: 8px; display: block; width: 100%; text-align: center !important; overflow-wrap: anywhere; word-break: break-word;" class="title">${e("onboarding.page1.title")}</h1>
        <p style="margin-top: 8px; text-align: center;" class="subtitle">${e("onboarding.page1.subtitle")}</p>
      </div>
      ...
      <div id="statContainer" style="opacity: 0; display: flex; flex-direction: column; align-items: center; gap: 72px; position: absolute; width: 100%; max-width: 335px;">
        <div id="stat1" style="opacity: 0; width: 100%;">
          ${a(i.value,i.subtitle)}
        </div>
        <div id="stat2" style="opacity: 0; width: 100%;">
          ${a(o.value,o.subtitle)}
        </div>
  ...
  `,b.push(setTimeout(()=>{const s=document.getElementById("text1"),n=document.getElementById("statContainer");s&&n&&(s.style.animation="fadeOutUp 0.8s ease forwards",b.push(setTimeout(()=>{n.style.opacity="1"},400)))},2e3)),b.push(setTimeout(()=>{const s=document.getElementById("stat1");s&&(s.style.animation="fadeInUp 0.8s ease forwards")},3100)),b.push(setTimeout(()=>{const s=document.getElementById("stat2");s&&(s.style.animation="fadeInUp 0.8s ease forwards")},3700)),b.push(setTimeout(()=>{const s=document.getElementById("stat3");s&&(s.style.animation="fadeInUp 0.8s ease forwards")},4300)),b.push(setTimeout(()=>{const s=document.getElementById("stat1"),n=document.getElementById("stat2"),r=document.getElementById("stat3"),l=document.getElementById("testimonialContainer");s&&(s.style.animation="fadeOutUp 0.8s ease forwards"),n&&(n.style.animation="fadeOutUp 0.8s ease forwards"),r&&(r.style.animation="fadeOutUp 0.8s ease forwards"),b.push(setTimeout(()=>{l&&(l.style.opacity="1",l.style.animation="fadeInUp 0.8s ease forwards"),b.push(setTimeout(()=>{l&&(l.style.animation="fadeOutUp 0.8s ease forwards"),b.push(setTimeout(()=>{c=1,q()},800))},2e3))},800))},5700))}function se(){const t=document.getElementById("app");t.innerHTML=`
    <div class="onboarding-page-2">
      ...
      <footer class="bottom-action">
        <div class="text-center mb-8 onboarding-text-block">
          <h1 style="font-size: 32px; animation: fadeInUp 0.6s ease forwards; white-space: normal; width: 100%; display: block; text-align: center !important; overflow-wrap: anywhere; word-break: break-word;" class="main-title">${e("onboarding.page2.title")}</h1>
  ...
  `,document.head.appendChild(i)}function oe(){const t=document.getElementById("app");t.innerHTML=`
    <div class="onboarding-page-3">
      ...
      <footer class="bottom-action">
        <div class="text-center mb-8 onboarding-text-block">
          <h1 style="font-size: 32px; animation: fadeInUp 0.6s ease forwards; white-space: normal; width: 100%; display: block; text-align: center !important; overflow-wrap: anywhere; word-break: break-word;" class="main-title">${e("onboarding.page3.title")}</h1>
  ...
  `,document.head.appendChild(i)}function ne(){const t=document.getElementById("app");t.innerHTML=`
  ...
  `,document.head.appendChild(i),window.selectOption=function(o){if(d)return;document.querySelectorAll(".option-card").forEach(s=>{s.classList.remove("selected"),s.style.pointerEvents="none"}),event.target.closest(".option-card").classList.add("selected"),F(1),setTimeout(()=>{nextPage()},500)}}function ae(){const t=document.getElementById("app");t.innerHTML=`
  ...
  `,document.head.appendChild(i),window.selectOption=function(o){if(d)return;document.querySelectorAll(".option-card").forEach(s=>{s.classList.remove("selected"),s.style.pointerEvents="none"}),event.target.closest(".option-card").classList.add("selected"),F(2),setTimeout(()=>{nextPage()},500)}}function re(){const t=document.getElementById("app");t.innerHTML=`
  ...
  `,document.head.appendChild(i),window.goToNextFromStylePage=function(){F(3),nextPage()},window.toggleOption=function(o,a){const s=document.querySelector(`[onclick="toggleOption('${o}', '${a}')"]`),n=document.getElementById("continueButton");if(s){const r=s.classList.contains("selected");s.classList.toggle("selected");let l=[];if(o==="style"?(l=document.querySelectorAll(".style-card.selected"),C=[],l.forEach(y=>{const w=y.getAttribute("onclick").match(/toggleOption\('style',\s*'([^']+)'\)/);w&&w[1]&&C.push(w[1])})):o==="palette"?l=document.querySelectorAll(".palette-card.selected"):o==="brush"&&(l=document.querySelectorAll(".brush-card.selected")),n)if(l.length>=1){if(n.style.opacity="1",n.style.visibility="visible",n.disabled=!1,!r&&l.length===1){const y=document.querySelector(".progress-bar-fill");if(y){const v=parseInt(y.getAttribute("data-question"));v&&v>f&&F(v)}}}else n.style.opacity="0",n.style.visibility="hidden",n.disabled=!0}}}function le(){const t=document.getElementById("app");t.innerHTML=`
  ...
  `,document.head.appendChild(i),window.selectOption=function(o){if(d)return;document.querySelectorAll(".option-item").forEach(n=>{n.classList.remove("selected"),n.style.pointerEvents="none";const r=n.querySelector(".option-checkbox");r&&r.classList.remove("selected");const l=n.querySelector(".option-text");l&&l.classList.remove("selected-text");const y=n.querySelector(".option-icon");y&&(y.style.fontVariationSettings="")});const s=event.target.closest(".option-item");if(s){s.classList.add("selected");const n=s.querySelector(".option-checkbox");n&&n.classList.add("selected");const r=s.querySelector(".option-text");r&&r.classList.add("selected-text");const l=s.querySelector(".option-icon");l&&(l.style.fontVariationSettings="'FILL' 1")}F(4),setTimeout(()=>{nextPage()},500)}}function pe(){const t=document.getElementById("app");t.innerHTML=`
  ...
  `;const i=["🎨","🖌️","🌈","✏️","🎭","✨","🌟","💫"],o=document.getElementById("emojiContainer"),a=50,s=50,n=48,r=32,l=[.15*Math.PI,.65*Math.PI,1.15*Math.PI,1.65*Math.PI,.4*Math.PI,.9*Math.PI,1.4*Math.PI,1.9*Math.PI],y=[...i].sort(()=>Math.random()-.5);for(let g=0;g<8;g++){const u=document.createElement("div");u.className="emoji",u.textContent=y[g];const m=g<4?[n,r]:[r,n],x=m[Math.floor(Math.random()*m.length)],S=l[g],O=a+x*Math.cos(S),H=s+x*Math.sin(S);u.style.left=`${O}%`,u.style.top=`${H}%`,u.style.setProperty("--emoji-index",g),o.appendChild(u)}const v=document.createElement("style");v.textContent=`
    .ring-container {
      position: absolute;
      top: 0;
      left: 0;
  ...
  `,document.head.appendChild(v);function w(){if(C.length===0)return e("loading.matched.single");const g=W(),u=C.map(x=>e(`styles.${x}`));if(u.length<=3)return e("loading.matched.multi",{styles:u.join(g)});const m=u.slice(0,3).join(g);return e("loading.matched.many",{firstThree:m,count:u.length})}setTimeout(()=>{const g=document.getElementById("loadingCircle"),u=document.getElementById("loadingText1"),m=document.getElementById("loadingText2"),x=document.getElementById("loadingText3"),S=document.getElementById("tryButton");g&&(g.className="loading-check",g.innerHTML="✓"),u&&(u.style.animation="scaleOut 0.3s ease forwards"),setTimeout(()=>{m&&(m.textContent=w(),m.style.visibility="visible",m.style.animation="popIn 0.3s ease forwards"),setTimeout(()=>{m&&(m.style.animation="scaleOut 0.3s ease forwards"),setTimeout(()=>{x&&(x.style.visibility="visible",x.style.animation="popIn 0.3s ease forwards"),S&&setTimeout(()=>{S.style.animation="fadeInUp 0.6s ease forwards"},300)},500)},1500)},500)},3e3)}function ce(){const t=document.getElementById("app"),i=new Date,o=new Date(i);o.setDate(o.getDate()+3);const a=new Intl.DateTimeFormat(N(),{year:"numeric",month:"short",day:"numeric"}).format(o),s=e("onboarding.page1.title"),n=encodeURIComponent(e("common.imageLoadFailed"));t.innerHTML=`
    <div class="trial-intro-page" style="font-family: 'PingFang SC', 'SF Pro', sans-serif; background-color: #FFFFFF; color: #000000; height: 100vh; height: 100dvh; display: flex; flex-direction: column;">
      ...
      <main style="flex: 1; padding-top: 0; display: flex; flex-direction: column; align-items: center; overflow-y: auto;">
        ...
        <div class="hero-section">
          <img class="hero-image" src="/images/Frame 11-2_副本2.png" alt="${s}" onerror="this.onerror=null; this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22400%22 height=%22400%22 viewBox=%220 0 400 400%22%3E%3Crect fill=%22%23FED11F%22 width=%22400%22 height=%22400%22/%3E%3Ctext fill=%22%23000000%22 font-family=%22PingFang SC, SF Pro%22 font-size=%2220%22 x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22%3E${n}%3C/text%3E%3C/svg%3E';">
          ...
          <div class="timeline-container">
            ...
            <div class="timeline-item" style="margin-top: 18px;">
              ...
              <div class="timeline-content">
                ...
                <p class="timeline-description">${e("trial.day3.description",{date:a})}</p>
              </div>
            </div>
          </div>
        </div>
  ...
  `;const l=document.getElementById("trial-intro-page-styles");l&&l.remove(),document.head.appendChild(r)}window.goToSubscription=function(){if(d)return;d=!0;const i=document.getElementById("app").firstElementChild;i&&i.classList.add("page-transition-exit"),setTimeout(()=>{c=9,q(),setTimeout(()=>{d=!1},400)},300)};function ue(){const t=document.getElementById("app"),i=e("onboarding.page1.title"),o=encodeURIComponent(e("common.imageLoadFailed"));t.innerHTML=`
    <div class="subscription-page" style="font-family: 'PingFang SC', 'SF Pro', sans-serif; background-color: #FFFFFF; color: #000000; height: 100vh; height: 100dvh; display: flex; flex-direction: column;">
      ...
      <header style="position: fixed; top: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 0 20px; height: 56px; background-color: transparent; z-index: 50; animation: fadeInUp 0.2s ease forwards; opacity: 0;">
        ...
        <div class="language-switcher">
          ...
          <div id="lang-menu" class="language-menu hidden" role="menu">${K()}</div>
        </div>
      </header>
      ...
      <main style="flex: 1; padding-top: 0; display: flex; flex-direction: column; align-items: center; justify-content: flex-start; padding-bottom: 0; overflow: hidden; position: relative; top: 0;">
        <!-- Hero Section -->
        <div class="hero-section">
          <img class="hero-image" src="/images/Frame 11-2_副本2.png" alt="${i}" onerror="this.onerror=null; this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22400%22 height=%22400%22 viewBox=%220 0 400 400%22%3E%3Crect fill=%22%23FED11F%22 width=%22400%22 height=%22400%22/%3E%3Ctext fill=%22%23000000%22 font-family=%22PingFang SC, SF Pro%22 font-size=%2220%22 x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22%3E${o}%3C/text%3E%3C/svg%3E';">
          <div class="hero-gradient"></div>
        </div>
  ...
  `;const a=document.createElement("style");a.id="subscription-page-styles",a.textContent=`
    .subscription-page {
      min-height: 100vh;
      min-height: 100dvh;
      display: flex;
  ...
  `;const s=document.getElementById("subscription-page-styles");s&&s.remove(),document.head.appendChild(a),Q()}window.toggleSubscription=function(t){const i=document.getElementById("weekly-plan"),o=document.getElementById("monthly-plan"),a=document.getElementById("yearly-plan"),s=document.getElementById("weekly-check"),n=document.getElementById("monthly-check"),r=document.getElementById("yearly-check"),l=document.getElementById("subscription-button");t==="weekly"?(i.classList.add("subscription-card-selected"),s.innerHTML='<svg width="14" height="14" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 24L20 34L40 14" stroke="#724202" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>',s.style.cssText="width: 20px; height: 20px; border-radius: 50%; background-color: #FED11F; border: 1px solid #FED11F; display: flex; align-items: center; justify-content: center;",o.classList.remove("subscription-card-selected"),n.innerHTML="",n.style.cssText="width: 20px; height: 20px; border-radius: 50%; background-color: transparent; border: 1px solid #E2E2E2; display: flex; align-items: center; justify-content: center;",a.classList.remove("subscription-card-selected"),r.innerHTML="",r.style.cssText="width: 20px; height: 20px; border-radius: 50%; background-color: transparent; border: 1px solid #E2E2E2; display: flex; align-items: center; justify-content: center;",l&&(l.textContent=e("subscription.button.freeTrial"))):t==="monthly"?(o.classList.add("subscription-card-selected"),n.innerHTML='<svg width="14" height="14" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 24L20 34L40 14" stroke="#724202" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>',n.style.cssText="width: 20px; height: 20px; border-radius: 50%; background-color: #FED11F; border: 1px solid #FED11F; display: flex; align-items: center; justify-content: center;",i.classList.remove("subscription-card-selected"),s.innerHTML="",s.style.cssText="width: 20px; height: 20px; border-radius: 50%; background-color: transparent; border: 1px solid #E2E2E2; display: flex; align-items: center; justify-content: center;",a.classList.remove("subscription-card-selected"),r.innerHTML="",r.style.cssText="width: 20px; height: 20px; border-radius: 50%; background-color: transparent; border: 1px solid #E2E2E2; display: flex; align-items: center; justify-content: center;",l&&(l.textContent=e("subscription.button.subscribe"))):t==="yearly"&&(a.classList.add("subscription-card-selected"),r.innerHTML='<svg width="14" height="14" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 24L20 34L40 14" stroke="#724202" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>',r.style.cssText="width: 20px; height: 20px; border-radius: 50%; background-color: #FED11F; border: 1px solid #FED11F; display: flex; align-items: center; justify-content: center;",i.classList.remove("subscription-card-selected"),s.innerHTML="",s.style.cssText="width: 20px; height: 20px; border-radius: 50%; background-color: transparent; border: 1px solid #E2E2E2; display: flex; align-items: center; justify-content: center;",o.classList.remove("subscription-card-selected"),n.innerHTML="",n.style.cssText="width: 20px; height: 20px; border-radius: 50%; background-color: transparent; border: 1px solid #E2E2E2; display: flex; align-items: center; justify-content: center;",l&&(l.textContent=e("subscription.button.subscribe")))};window.nextPage=function(){if(c<j-1&&!d){d=!0;const t=c;if(c++,t>=3&&t<=6){const i=t-2;i>f&&(f=i)}q(),setTimeout(()=>{d=!1},400)}};window.prevPage=function(){c>0&&!d&&(d=!0,c--,q(),setTimeout(()=>{d=!1},400))};window.skipToPage=function(t){c=t,q()};window.skipCurrentQuestion=function(){if(c<j-1){if(c>=3&&c<=6){const t=c-2;t>f&&(f=t)}c++,q()}};window.selectOption=function(t){document.querySelectorAll(".option").forEach(a=>{a.classList.remove("selected");const s=a.querySelector(".checkbox");s&&(s.innerHTML="",s.classList.remove("checked"))}),event.target.closest(".option").classList.add("selected");const o=event.target.closest(".option").querySelector(".checkbox");o&&(o.innerHTML="✓",o.classList.add("checked")),setTimeout(()=>{nextPage()},300)};window.selectGridOption=function(t){document.querySelectorAll(".grid-item").forEach(o=>{o.classList.remove("selected")}),event.target.closest(".grid-item").classList.add("selected"),setTimeout(()=>{nextPage()},300)};V();Y(()=>{q(!1)});q();
